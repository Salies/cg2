...
for x in range(10, 31):
    for y in range(20, 41):
        points.append((x, y, curve(x, y), (0, 0, 255)))

# Plano vermelho
for x in range(50, 101):
    for y in range(30, 81):
        points.append((x, y, plane(x, y), (255, 0, 0)))
...
for x, y, z in sphere_points:
    points.append((x, y, z, (0, 255, 0)))

# Cubo branco
for x in range(-20, 21):
    for y in range(-20, 21):
        points.append((x, y, -20, (255, 255, 255)))
        points.append((x, y, -20, (255, 255, 255)))
        points.append((x, y, 20, (255, 255, 255)))
        points.append((x, 20, y, (255, 255, 255)))
        points.append((x, -20, y, (255, 255, 255)))
        points.append((20, x, y, (255, 255, 255)))
        points.append((-20, x, y, (255, 255, 255)))
